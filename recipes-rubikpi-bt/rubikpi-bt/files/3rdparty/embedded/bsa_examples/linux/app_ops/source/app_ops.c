...
void set_qos_func(BD_ADDR bda_test)
{
    tBSA_TM_QOS QosReq;
    ...
    QosReq.flag = 0;
    QosReq.service_type  = 1;
    QosReq.token_rate = 0x00004600;
    QosReq.peak_bandwidth = 0;
    QosReq.latency = 10000;
    QosReq.delay_variation = 0xffffffff;
